<template>
  <div class="popup" v-if="popupError.show" @click.stop="close">
    <div class="yPopup__error">
...
export default class YPopupError extends Vue {
  get popupError() {
    return this.$store.getters.popupError
  }
  close() {
    this.$store.commit('closeErrorPopup')
  }
}
</script>
